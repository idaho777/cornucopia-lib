...
public:
  LineSceneItem(const Eigen::Vector2d &p1, const Eigen::Vector2d &p2,
                QString group, QPen pen = QPen(), QBrush brush = QBrush());
...
public:
  CurveSceneItem(Cornu::CurveConstPtr curve, QString group, QPen pen = QPen(),
                 QBrush brush = QBrush());
...
public:
  ImageSceneItem(QImage image, QString group)
      : SceneItem(group), _image(image) {}
